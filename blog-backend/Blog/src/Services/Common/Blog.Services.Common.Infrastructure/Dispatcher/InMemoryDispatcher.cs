...
namespace Blog.Services.Common.Infrastructure.Dispatcher;
...
internal sealed class InMemoryDispatcher : IDispatcher
{
    ...
    public Task<TResult> SendAsync<T, TResult>(T command, CancellationToken cancellationToken = default) where T : class, ICommand<TResult> where TResult : class
